...
(function ($) {
    $.fn.confetti = function (options) {
	    ...
	    save_button_label: 'Save' // label for save button
        }, options);
...
`;
        var buttons_html = `
<hr/>
<button class="cfti_savecancel cfti_savebutton">@save_label@</button>
...
`
	...
	if (!settings.readonly) {
	    var b_html = buttons_html.replace('@save_label@', settings.save_button_label);
            this.append(b_html);
